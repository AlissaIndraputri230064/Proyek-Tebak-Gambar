...
<body>
    ...
    <p><span class="label">NAME  : </span><span class="value"><?= $user['user_name'] ?></span></p>
    <p><span class="label">EMAIL : </span><span class="value"><?= $user['user_email'] ?></span></p>
    </div>
        <div class="profile-btn">

            <a href="<?= base_url("showEdit_profile")?>">
